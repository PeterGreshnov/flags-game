...
function getNRandomInts(requiredNumber) {
  ...
  for (let i = 0; i < requiredNumber; i++) {
    randomFlag = getRandomInt(countriesNumber);
...
function showNFlags(number) {
  ...
  for (let index = 0; index < number; index++) {
    ...
    newDiv.classList.add("flagContainer");
    ...
    flagsContainer.appendChild(newDiv);
  }

  let flagContainersArray = document.querySelectorAll("#flagContainer");

  flagContainersArray.forEach(function (elem) {
